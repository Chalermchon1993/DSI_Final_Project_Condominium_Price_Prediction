...
if __name__ == "__main__":
    ...
    # Loop through every district link
    for district, link in districts_dict.items():
        ...
        while next_page:
            ...
            wait.until(EC.visibility_of_element_located((By.CSS_SELECTOR, ".listing-information .btn-link")))
    ...
    print(f"This is the last district, It's time to make models!!!!!!!!!")


# Note:
# Huai Khwang start at page 16
# Bang Phlat start at page 30
# Phra Nakhon start at page 5
# Chom Thong start at page 16